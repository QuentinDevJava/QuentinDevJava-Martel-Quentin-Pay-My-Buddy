 ...
 * 
 * This interface extends {@link CrudRepository} to provide CRUD operations for
 ...
 * </p>
 * <ul>
 * <li><b>{@link #existsByEmailOrUsername} :</b> Checks if a user exists with
 * the given email address or username.</li>
 * <li><b>{@link #existsByEmailAndPasswordOrUsernameAndPassword} :</b> Checks if
 * a user exists with the email and password, or with the username and
 * password.</li>
 * <li><b>{@link #findByEmail} :</b> Finds a user by their email address.</li>
 * <li><b>{@link #byUsernameOrEmail} :</b> Finds a user by their email address
 * or username..</li>
 * </ul>
 */
@Repository
